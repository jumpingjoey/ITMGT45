...
def orderhistory():
    past_product_orders= db.past_product_orders(session["user"])
    return render_template("orderhistory.html", page="Order History", past_product_orders=past_product_orders)
